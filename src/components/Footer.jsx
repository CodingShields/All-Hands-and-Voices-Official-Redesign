				...
				<div class='mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8'>
					<div class='xl:grid xl:grid-cols-3 xl:gap-8'>
						<div class='space-y-8 xl:col-span-1'>
							<img src='assets/images/alabamahvlogo.svg' alt='Company name' class='max-w-sm' />
						...
						<div class='mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0'>
							<div class='md:grid md:grid-cols-2 md:gap-8'>
								<div style='grid-area: 1 / 1 / 2 / 3'>
									<h3 class='text-sm font-semibold uppercase tracking-wider text-gray-400'>Pages</h3>
							...
							<div class='md:grid md:grid-cols-2 md:gap-8' style='grid-area: 1 / 2 / 2 / 3'>
								<div>
